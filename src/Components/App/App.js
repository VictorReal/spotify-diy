...
class App extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      playlistTracks: [{name: 'playlistName1', artist: 'playlistArtist1', album: 'plylistAlbum1', id:4}, {name: 'playlistName2', artist: 'playlistArtist2', album: 'plylistAlbum2', id:5},{name: 'playlistName3', artist: 'playlistArtist3', album: 'plylistAlbum3', id:6}]
    }
  }
